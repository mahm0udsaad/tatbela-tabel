-- Ensure filtered/search results include full variant metadata for storefront badges.
-- Without this, UI only receives variant stock and falls back to "متوفر بأحجام متعددة".
