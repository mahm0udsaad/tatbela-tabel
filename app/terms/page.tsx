...
import { DEFAULT_TERMS } from "@/lib/site-content/defaults"
import { policyPagePayloadSchema } from "@/lib/site-content/schemas"

export const metadata: Metadata = {
  title: "الشروط والأحكام | تتبيلة & تابل",
  description: "الشروط والأحكام الخاصة باستخدام موقع تتبيلة وتابل وشراء المنتجات.",
}
...
export default async function TermsPage() {
  ...
  const payload = parsed.success ? parsed.data : DEFAULT_TERMS
      ...
      <main className="min-h-screen">
        <section className="py-24 px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="text-4xl font-bold text-[#2B2520] mb-4">الشروط والأحكام</h1>
