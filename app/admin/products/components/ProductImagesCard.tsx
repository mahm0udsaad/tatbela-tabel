...
export function ProductImagesCard({
  ...
  const hasImages = (selectedProduct?.product_images?.length ?? 0) > 0 || pendingImages.length > 0
    ...
    <div className="bg-white rounded-2xl shadow p-6 space-y-4">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        {selectedProduct?.product_images?.map((image) => (
          ...
          >
            <img src={image.image_url} alt={selectedProduct.name_ar} className="max-h-full max-w-full object-contain" loading="lazy" />
