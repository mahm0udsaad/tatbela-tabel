    ...
    let productsQuery = supabase
      ...
      .select(
        `
          ...
          product_variants (id, weight, size, variant_type, price, stock)
        `,
      )
            ...
            <div>
              ...
              <p className="text-lg text-[#8B6F47] max-w-2xl">
                {params.search 
                  ...
                  : "تشكيلة واسعة من التوابل المصرية والخلطات الأصلية المميزة، مختارة بعناية لتضيف طعمًا فريدًا لكل وجبة."
                }
              </p>
            </div>
