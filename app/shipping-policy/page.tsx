...
import { DEFAULT_SHIPPING_POLICY } from "@/lib/site-content/defaults"
import { policyPagePayloadSchema } from "@/lib/site-content/schemas"

export const metadata: Metadata = {
  title: "سياسة الشحن | تتبيلة & تابل",
  description: "معلومات الشحن والتوصيل لمنتجات تتبيلة وتابل.",
}
...
export default async function ShippingPolicyPage() {
  ...
  if (error) {
    console.error("Failed to load shipping policy settings", error)
  }
  ...
  const payload = parsed.success ? parsed.data : DEFAULT_SHIPPING_POLICY
      ...
      <main className="min-h-screen">
        <section className="py-24 px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="text-4xl font-bold text-[#2B2520] mb-4">سياسة الشحن</h1>
